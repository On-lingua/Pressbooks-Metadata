<section id="post-<?php the_ID(); ?>" <?php post_class( array( 'top-block', 'clearfix', 'home-post' ) ); ?>>
	...
	$meta=$pm_BM->get_current_metadata_flat();
        ...
        <div class="log-wrap" style="left: 0px;">	<!-- Home/Library -->
	   <?php if (! is_single()): ?>
			...
			<div class="book-info">
				...
				<div class="book-cover">
				     <?php
                                                        ...
                                                        array_values($pathparts);  
                                                        $filepath=implode('/', $pathparts);
                                                                $bookcoverpath=$filepath.'/wp-content/plugins/Pressbooks-Metadata/themes/pressbooks-lingua-theme/images/lingua_book_cover'.$level.'.jpg';
                                                        ?>
