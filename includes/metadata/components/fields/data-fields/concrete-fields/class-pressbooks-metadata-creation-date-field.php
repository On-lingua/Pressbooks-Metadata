...
/**
 * The creation date of the current page.
 *
 * @since      0.1
 *
 ...
 */
class Pressbooks_Metadata_Creation_Date_Field extends Pressbooks_Metadata_Built_In_Field {
	...
	public function __construct( $name = '', $slug = '', $itemprop = '' ) {
		...
		if ( empty( $actual_name ) ) {
			$actual_name = 'Creation date';
		}
		$actual_slug = $slug;
		if ( empty( $actual_slug ) ) {
			$actual_slug = 'creation_date';
		}
